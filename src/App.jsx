...
{month:4,date:"7 abr",name:"Dia Mundial de la Salud (OMS)",cat:"farma",note:"El dia mas importante del anio para farma, seguros y salud. Campania obligada.",clients:["Pilexil","Isogona","Dormidina","Rinocusi","Talquistina","Sérélys","Hydrafizz","CaixaBank Payments and Consumer","Abanca"]},
...
{month:5,date:"10 may",name:"Dia de la Salud Mental",cat:"farma",note:"Bienestar mental creciente en conversacion social.",clients:["Dormidina","Isogona","CaixaBank Payments and Consumer","Abanca","Sérélys"]},
...
{month:5,date:"17 may",name:"Dia Mundial de la Reposteria 🧁",cat:"granconsumo",note:"Muy viral. Alimentacion, hosteleria, home baking, menaje.",clients:["Nutella","Haribo","Gallina Blanca","Makro","Lekué"]},
...
{month:6,date:"21 jun",name:"Dia Internacional del Yoga 🧘",cat:"daykeeting",note:"Bienestar, mindfulness, salud. Muy popular en RRSS.",clients:["Isogona","Granini","Sérélys"]},
...
{month:7,date:"26 jul",name:"Dia de los Abuelos 👴",cat:"granconsumo",note:"Familia multigeneracional. Gran consumo y farma senior.",clients:["Gallina Blanca","Sérélys","Isogona","CaixaBank Payments and Consumer","Abanca"]},
...
{month:8,date:"15 ago",name:"Asuncion de la Virgen - FESTIVO NACIONAL",cat:"festivo",note:"Pico de vacaciones. Turismo, hosteleria, distribucion.",clients:["Freixenet","Torres Brandy","Granini","Haribo","Makro","Talquistina"]},
...
// SEPTIEMBRE
{month:9,date:"1 sep",name:"Vuelta al Cole",cat:"granconsumo",note:"El pico de compra escolar. Mochilas, material, alimentacion, farma, ahorro familiar.",clients:["Staedtler","Erasco","CaixaBank Payments and Consumer","Abanca","Haribo","Nutella","Granini","Gallina Blanca","Isogona","Pilexil","Makro","Primaprix","Pago","Frit Ravich","Pepephone"]},
...
{month:9,date:"10 sep",name:"Dia Mundial Prevencion del Suicidio 💙",cat:"farma",note:"Salud mental. Muy sensible.",clients:["Dormidina","Sérélys","CaixaBank Payments and Consumer","Abanca"]},
...
{month:9,date:"TBC sep",name:"Festival de San Sebastian",cat:"pelicula",note:"El festival de cine mas importante de Espana. Alfombra dorada.",clients:["Freixenet","Torres Brandy","CaixaBank Payments and Consumer","Abanca"]},
...
{month:9,date:"21 sep",name:"Dia Mundial del Alzheimer 🧠",cat:"farma",note:"Enfermedades neurodegenerativas. Farma y bienestar senior.",clients:["Sérélys","Isogona","CaixaBank Payments and Consumer","Abanca"]},
...
{month:9,date:"25 sep",name:"Dia del Farmaceutico 💊",cat:"farma",note:"El dia de la profesion farmaceutica. Todo el portfolio farma.",clients:["Pilexil","Isogona","Dormidina","Rinocusi","Talquistina","Sérélys"]},
...
{month:9,date:"29 sep",name:"Dia Mundial del Corazon ❤️",cat:"farma",note:"El mayor dia de farma cardiovascular del anio.",clients:["Isogona","Sérélys","CaixaBank Payments and Consumer","Abanca","Gallina Blanca"]},
...
// OCTUBRE
{month:10,date:"1 oct",name:"Dia Internacional de las Personas Mayores 👴",cat:"farma",note:"Salud senior, suplementacion.",clients:["Pilexil","Isogona","Dormidina","Sérélys","CaixaBank Payments and Consumer","Abanca"]},
...
{month:10,date:"9 oct",name:"Dia Mundial del Huevo 🥚",cat:"granconsumo",note:"Alimentacion basica. Muy viral y facil de activar.",clients:["Gallina Blanca","Makro","Nutella"]},
{month:10,date:"10 oct",name:"Dia Mundial Salud Mental 🧠",cat:"farma",note:"El dia mas importante del anio para salud mental.",clients:["Dormidina","Isogona","Sérélys","CaixaBank Payments and Consumer","Abanca"]},
...
{month:10,date:"18 oct",name:"Dia Mundial de la Menopausia 🌸",cat:"farma",note:"Salud femenina. Farma hormonal y bienestar femenino.",clients:["Sérélys","Isogona"]},
{month:10,date:"19 oct",name:"Dia Mundial Lucha contra el Cancer de Mama",cat:"farma",note:"El mayor dia de visibilidad del anio para oncologia.",clients:["Pilexil","CaixaBank Payments and Consumer","Abanca","Sérélys","Hydrafizz"]},
{month:10,date:"20 oct",name:"Dia Internacional del Chef 🧑‍🍳",cat:"granconsumo",note:"Gastronomia premium. Hosteleria y alimentacion.",clients:["Gallina Blanca","Makro","Freixenet","Torres Brandy","Frit Ravich","Kagura"]},
...
{month:10,date:"25 oct",name:"Dia de la Pasta 🍝",cat:"granconsumo",note:"Alimentacion. Muy viral y facil de activar.",clients:["Gallina Blanca","Makro","Nutella"]},
...
{month:11,date:"14 nov",name:"Dia Mundial de la Diabetes 💙",cat:"farma",note:"El mayor dia de farma diabetologica del anio.",clients:["Isogona","Sérélys","Gallina Blanca","CaixaBank Payments and Consumer","Abanca"]},
...
{month:11,date:"25 nov",name:"Dia Internacional Contra Violencia de Genero 🟣",cat:"daykeeting",note:"Alta conversacion social. Marcas con valores deben activar.",clients:["CaixaBank Payments and Consumer","Abanca","Sérélys"]},
...
{month:12,date:"3 dic",name:"Dia del Medico 👨‍⚕️",cat:"farma",note:"La profesion medica. Todo el portfolio farma.",clients:["Pilexil","Isogona","Dormidina","Rinocusi","Talquistina","Sérélys"]},
