...
const CC={"Haribo":"#E11D48","Nutella":"#B45309","Granini":"#D97706","Freixenet":"#7C3AED","Torres Brandy":"#374151","Torres Brandy USA":"#1D4ED8","Vina Sol":"#059669","Gallina Blanca":"#EA580C","Hero":"#DC2626","Makro":"#0891B2","Freshly Cosmetics":"#DB2777","Loewe":"#111827","Ekue":"#7C3AED","Flavia":"#BE185D","Talquistina":"#0284C7","CaixaBank":"#B45309","Abanca":"#16A34A","M2P":"#4F46E5","Pagofacil":"#0891B2","Pilexil":"#7C3AED","Fito":"#16A34A","MBS":"#059669","Isogona":"#0284C7","Dormidina":"#4F46E5","Midnavi":"#6D28D9","Rinocusi":"#B45309","Serelys":"#DB2777","Musc Intime":"#9D174D","Hydrafizz":"#0891B2","AOC":"#374151","Tech":"#4F46E5","Parlem":"#1D4ED8","Bluespace":"#0891B2","Digia":"#7C3AED","Castrol":"#DC2626","Frigicoll":"#0284C7","Jotun":"#EA580C","Staedtler":"#DC2626","Erasco":"#D97706"};
const EVENTS=[
// ABRIL
...
{month:4,date:"27 abr",name:"Dia Mundial del Diseno Grafico 🖌️",cat:"daykeeting",note:"Creatividad visual. Marcas de diseno, agencias, software.",clients:["Staedtler","AOC","Loewe","Freshly Cosmetics","Digia"]},
...
{month:5,date:"15 may",name:"Berlin y la Dama del Arminno T2 (Netflix)",cat:"serie",note:"Spin-off La Casa de Papel. Pedro Alonso en Sevilla. Robo de un Da Vinci.",clients:["Freixenet","Torres Brandy","CaixaBank","Abanca","Makro"]},
...
{month:5,date:"17 may",name:"Dia Mundial contra la Homofobia (IDAHOBIT) 🏳️‍🌈",cat:"daykeeting",note:"Diversidad e inclusion. Marcas con valores.",clients:["CaixaBank","Abanca","Freshly Cosmetics","Loewe","Parlem","Freixenet"]},
...
{month:5,date:"18 may",name:"Dia Internacional de los Museos 🏛️",cat:"daykeeting",note:"Cultura y arte. Marcas con identidad cultural.",clients:["Loewe","Torres Brandy","Freixenet","Staedtler"]},
...
{month:6,date:"11 jun",name:"MUNDIAL FIFA 2026 - ARRANCA",cat:"deporte",note:"EE.UU., Mexico, Canada. 48 selecciones. El evento deportivo del anio. Espana participa.",clients:["CaixaBank","Abanca","Freixenet","Torres Brandy","Granini","Haribo","Nutella","Gallina Blanca","Makro","AOC","Castrol"]},
...
{month:6,date:"20 jun",name:"Yellow Day - el dia mas feliz del anio ☀️",cat:"daykeeting",note:"Positividad, alegria, bienestar. Muy compartible.",clients:["Haribo","Nutella","Granini","Freshly Cosmetics","Freixenet"]},
...
{month:6,date:"25-28 jun",name:"Resurrection Fest 2026 - Viveiro",cat:"festival",note:"Iron Maiden (Run For Your Lives Tour), Limp Bizkit (unico concierto en Espana), Marilyn Manson. Del 1 al 4 de julio.",clients:["Freixenet","Torres Brandy","Makro","CaixaBank"]},
...
{month:6,date:"28 jun",name:"Dia Internacional Orgullo LGTBIQ+ 🏳️‍🌈",cat:"daykeeting",note:"El dia de mayor alcance para diversidad en redes.",clients:["CaixaBank","Abanca","Freshly Cosmetics","Loewe","Freixenet","Granini","Parlem"]},
{month:6,date:"30 jun",name:"Dia de las Redes Sociales 📲",cat:"daykeeting",note:"El dia de las RRSS. Perfecto para todas las marcas activas en social media.",clients:["CaixaBank","Abanca","Parlem","Tech","AOC","Freshly Cosmetics","Haribo","Granini","Nutella"]},
...
// JULIO
{month:7,date:"1 jul",name:"Inicio Rebajas de Verano 🛍️",cat:"granconsumo",note:"Pico de consumo en retail, moda y gran consumo. Ecommerce.",clients:["Freshly Cosmetics","Loewe","Ekue","Flavia","CaixaBank","Abanca","Pagofacil","M2P","Haribo","Nutella"]},
...
{month:7,date:"1-4 jul",name:"Resurrection Fest - Viveiro (Lugo)",cat:"festival",note:"Iron Maiden, Limp Bizkit, Marilyn Manson, Trivium, P.O.D., The Rasmus. El mayor festival de metal de Espana.",clients:["Freixenet","Torres Brandy","Makro","CaixaBank"]},
...
{month:7,date:"6-9 jul",name:"Garbage - gira Espana (Coruna, Valencia, Barcelona)",cat:"concierto",note:"6 jul A Coruna, 8 jul Valencia, 9 jul Barcelona. Alternativo 90s de vuelta.",clients:["Freixenet","Torres Brandy","AOC"]},
...
{month:7,date:"8-11 jul",name:"Mad Cool 2026 - Madrid",cat:"festival",note:"Foo Fighters, Florence+Machine, Lorde, Twenty One Pilots, Kings of Leon, Nick Cave, Halsey, Pixies, Charlie Puth.",clients:["Freixenet","Torres Brandy","Granini","CaixaBank","Abanca","AOC","Freshly Cosmetics","Makro"]},
...
{month:7,date:"9-10 jul",name:"Sting - gira Espana (Canarias, Cadiz, Malaga, Granada, Sevilla)",cat:"concierto",note:"Sting abre gira en Canarias (9 y 10 jul) y recorre Andalucia. Pop/rock clasico.",clients:["Torres Brandy","Freixenet","CaixaBank","Abanca"]},
{month:7,date:"8 jul",name:"Vaiana - Live-Action Disney (cines Espana)",cat:"pelicula",note:"Remake accion real de Moana. Dwayne Johnson como Maui. 10 aniversario.",clients:["Haribo","Nutella","Hero","Granini","Freshly Cosmetics"]},
...
{month:7,date:"13 jul",name:"Dia Mundial del Rock 🎸",cat:"daykeeting",note:"Musica rock. Gran engagement en comunidad musical.",clients:["Torres Brandy","Freixenet","AOC","Makro"]},
{month:7,date:"14-15 jul",name:"Aitana - Madrid (Movistar Arena) 3a y 4a noche",cat:"concierto",note:"4 noches en Madrid en total. Fenomeno historico.",clients:["Freshly Cosmetics","Loewe","Ekue","Freixenet","Granini","CaixaBank","Abanca"]},
...
{month:7,date:"17 jul",name:"La Odisea (Christopher Nolan)",cat:"pelicula",note:"Homero en IMAX. El evento cinematografico del verano. Expectacion maxima.",clients:["AOC","CaixaBank","Abanca","Torres Brandy","Freixenet"]},
...
{month:7,date:"18 jul",name:"Dia Internacional de Nelson Mandela 🕊️",cat:"daykeeting",note:"Justicia, igualdad, valores. RSC.",clients:["CaixaBank","Abanca","Hero","Freshly Cosmetics"]},
...
{month:7,date:"24 jul",name:"Stuart Fails to Save the Universe (HBO Max)",cat:"serie",note:"Spin-off de The Big Bang Theory. Stuart Bloom salva el universo de una realidad alternativa. Estreno muy esperado por fans de la franquicia.",clients:["AOC","Haribo","Nutella","Granini","CaixaBank"]},
...
{month:7,date:"30 jul",name:"Bruno Mars - Madrid (Estadio Metropolitano)",cat:"concierto",note:"Unico concierto en Espana de Bruno Mars. Pop/soul masivo. Entradas agotadas.",clients:["Freixenet","Torres Brandy","CaixaBank","Abanca","Granini"]},
{month:7,date:"24 jul",name:"Hoppers (Pixar / Disney+) - NUEVO",cat:"pelicula",note:"Pixar original. Mabel transfiere su mente a un castor robot para salvar su habitat de una empresa. Pixar de autor. Ya disponible en Disney+.",clients:["Haribo","Nutella","Hero","Granini","CaixaBank"]},
...
{month:7,date:"31 jul",name:"Spider-Man: Brand New Day",cat:"pelicula",note:"Tom Holland regresa. Con Hulk (Ruffalo) y Punisher (Bernthal). Conversacion Marvel maxima.",clients:["Haribo","Nutella","AOC","Granini","Hero"]},
{month:7,date:"31 jul-2 ago",name:"Low Festival - Benidorm",cat:"festival",note:"Kasabian, The Hives, Editors, Dani Fernandez, Fangoria, Love of Lesbian, La Casa Azul, Natalia Lacunza. Festival indie junto al mar.",clients:["Freixenet","Torres Brandy","Granini","CaixaBank","Freshly Cosmetics"]},
// AGOSTO
...
{month:8,date:"5 ago",name:"Ted Lasso T4 (Apple TV+)",cat:"serie",note:"Regreso del entrenador mas querido del streaming. Expectacion masima tras 3 anios de espera. Serie fenomeno cultural.",clients:["CaixaBank","Abanca","AOC","Freixenet"]},
...
{month:8,date:"14 ago",name:"Aitana - Madrid (Movistar Arena) - septiembre",cat:"concierto",note:"Ver fechas de septiembre para las noches de Madrid (11, 12, 14 y 15 sep).",clients:["Freshly Cosmetics","Loewe","Ekue","Freixenet","Granini","CaixaBank","Abanca"]},
{month:8,date:"13 ago",name:"Camp Rock 3 (Disney Channel / Disney+) - NUEVO",cat:"pelicula",note:"18 anios despues de la primera! Jonas Brothers regresan como Connect 3. Demi Lovato como productora. Nostalgia generacional maxima. Disney Channel el 13 ago y Disney+ el 14 ago.",clients:["Haribo","Nutella","Freshly Cosmetics","Loewe","Granini","CaixaBank","Abanca","Freixenet"]},
...
{month:8,date:"17 ago",name:"Lanterns / Linternas (HBO Max)",cat:"serie",note:"Hal Jordan y John Stewart, los Green Lanterns, investigan un asesinato en la nueva serie DC. La mas esperada del universo DC en 2026.",clients:["AOC","CaixaBank","Abanca","Haribo","Nutella","Granini"]},
...
{month:8,date:"23 ago",name:"Dia Mundial del Hashtag #️⃣",cat:"daykeeting",note:"El dia de los hashtags. Perfecto para hablar de RRSS y estrategia digital.",clients:["Parlem","Tech","AOC","Digia","CaixaBank","Abanca"]},
{month:8,date:"26 ago",name:"Tadeo Jones 3 - Estreno cines",cat:"pelicula",note:"El aventurero espaniol favorito regresa. Animacion espanola de primer nivel. Audiencia familiar y muy alta expectacion.",clients:["Haribo","Nutella","Hero","Granini","Staedtler","CaixaBank"]},
{month:8,date:"28 ago",name:"La Muerte de Robin Hood (cines)",cat:"pelicula",note:"Hugh Jackman como Robin Hood en sus ultimos dias. Jodie Comer, Bill Skarsgard. Drama de accion historico.",clients:["CaixaBank","Abanca","Torres Brandy","Freixenet"]},
{month:8,date:"28 ago",name:"Javier Bardem - pelicula espanola (cines)",cat:"pelicula",note:"Regreso del Oscar espaniol mas internacional al cine nacional.",clients:["CaixaBank","Abanca","Torres Brandy","Freixenet"]},
{month:8,date:"28-30 ago",name:"The Weeknd - Madrid (Estadio Metropolitano)",cat:"concierto",note:"After Hours Til Dawn Tour. 3 noches en el Metropolitano. R&B global de primer nivel. Con Playboi Carti.",clients:["Freixenet","Torres Brandy","Freshly Cosmetics","Loewe","CaixaBank","Granini"]},
...
{month:8,date:"28 ago",name:"Dark Matter T2 (Apple TV+)",cat:"serie",note:"Regreso del thriller cuantico de ciencia ficcion. Joel Edgerton. Una de las series mas vistas de Apple TV+ en 2025.",clients:["AOC","CaixaBank","Abanca","Tech"]},
...
{month:9,date:"3-6 sep",name:"Ebrovision - Miranda de Ebro (Burgos)",cat:"festival",note:"Carlos Ares, Getdown Services, Hoonine, Los Chivatos, Mujeres. Festival indie alternativo.",clients:["Freixenet","Torres Brandy","CaixaBank","Abanca"]},
{month:9,date:"4-5 sep",name:"Vive Latino 2026 - Zaragoza (Espacio Expo)",cat:"festival",note:"Amaia, Guitarricadelafuente, Julieta Venegas, La M.O.D.A., Rigoberta Bandini, La Plazuela, Loquillo. Musica iberoamericana.",clients:["Freixenet","Torres Brandy","Granini","CaixaBank","Abanca"]},
...
{month:9,date:"11-12 sep",name:"Billy Corgan (Smashing Pumpkins) - Madrid (Vistalegre)",cat:"concierto",note:"Revisita el disco Mellon Collie and the Infinite Sadness con orquesta y coro. Evento unico.",clients:["Torres Brandy","Freixenet","CaixaBank","Abanca","AOC"]},
{month:9,date:"11-12 sep",name:"Granada Sound 2026 - Granada (Cortijo del Conde)",cat:"festival",note:"Fangoria, La La Love You, Belen Aguilera, Pignoise, Carlos Sadness, Marlena, La Sonrisa De Julia.",clients:["Freixenet","Torres Brandy","Granini","CaixaBank","Abanca"]},
...
{month:9,date:"11-15 sep",name:"Aitana - Madrid (Movistar Arena, 4 noches)",cat:"concierto",note:"Cuarto Azul World Tour en Madrid. 11, 12, 14 y 15 septiembre. Fenomeno historico.",clients:["Freshly Cosmetics","Loewe","Ekue","Freixenet","Granini","CaixaBank","Abanca"]},
...
{month:9,date:"16 sep",name:"Neagley (Prime Video)",cat:"serie",note:"Spin-off de Reacher. Frances Neagley como detective privada en Chicago. Accion y thriller.",clients:["CaixaBank","Abanca","AOC"]},
{month:9,date:"18-19 sep",name:"Brava Festival 2026 - Madrid (Caja Magica)",cat:"festival",note:"Sugababes, Natalie Imbruglia, Fangoria, Inna, Vengaboys, Leire Martinez, Maria Pelae, Soraya. Festival pop y nostalgia.",clients:["Freixenet","Torres Brandy","Granini","CaixaBank","Abanca","Freshly Cosmetics"]},
{month:9,date:"18-27 sep",name:"Shakira - Madrid (residencia, 6 noches)",cat:"concierto",note:"Estadio Shakira: 18, 19, 20, 25, 26 y 27 sept. El evento del otonio. 12 noches en Madrid en total.",clients:["Freixenet","Torres Brandy","Freshly Cosmetics","Loewe","CaixaBank","Abanca","Granini","Nutella"]},
...
{month:9,date:"TBC sep",name:"Festival de San Sebastian",cat:"pelicula",note:"El festival de cine mas importante de Espana. Alfombra dorada.",clients:["Freixenet","Torres Brandy","Loewe","CaixaBank","Abanca"]},
{month:9,date:"TBC sep",name:"The Black Keys - Madrid",cat:"concierto",note:"El duo de blues rock de Ohio regresa a Espana.",clients:["Torres Brandy","Freixenet","AOC","CaixaBank"]},
{month:9,date:"TBC sep",name:"The Neighbourhood - Madrid",cat:"concierto",note:"Indie pop oscuro. Wiped Out! y Sweater Weather.",clients:["Freixenet","AOC","CaixaBank","Abanca"]},
...
{month:9,date:"21 sep",name:"Dia Internacional de la Paz ☮️",cat:"daykeeting",note:"Valores universales. Marcas con proposito.",clients:["CaixaBank","Abanca","Freshly Cosmetics","Hero","Granini","Parlem"]},
...
{month:9,date:"25 sep",name:"Verity: La Sombra de un Engano (cines)",cat:"pelicula",note:"Adaptacion del thriller de Colleen Hoover. Nicole Kidman y Edgar Ramirez. Muy esperado por fans de novela romantica-thriller.",clients:["Freshly Cosmetics","Loewe","CaixaBank","Abanca"]},
...
{month:9,date:"27 sep",name:"Dia Mundial del Turismo ✈️",cat:"granconsumo",note:"Hosteleria, destinos, agencias.",clients:["CaixaBank","Abanca","Freixenet","Torres Brandy","Makro","Gallina Blanca"]},
{month:9,date:"29 sep",name:"Dia Mundial del Corazon ❤️",cat:"farma",note:"El mayor dia de farma cardiovascular del anio.",clients:["Fito","MBS","Isogona","Serelys","CaixaBank","Abanca","Gallina Blanca","Hero"]},
{month:9,date:"30 sep",name:"Dia Internacional del Podcast 🎙️",cat:"daykeeting",note:"Audio digital. Marcas con contenido y comunicacion.",clients:["Parlem","Tech","CaixaBank","Abanca","Digia","AOC"]},
// OCTUBRE
...
{month:10,date:"2-11 oct",name:"Shakira - Madrid (cierre residencia, 5 noches)",cat:"concierto",note:"2, 3, 4, 10 y 11 oct. 11 noches totales en Madrid. Fenomeno historico.",clients:["Freixenet","Torres Brandy","Freshly Cosmetics","Loewe","CaixaBank","Abanca"]},
{month:10,date:"3 oct",name:"Estreno MONSTRUO: Ed Gein (Netflix)",cat:"serie",note:"Ryan Murphy. Nueva entrega de la saga (Dahmer, Hermanos Mendez). Expectacion maxima.",clients:["AOC","Haribo","Freixenet","Torres Brandy"]},
...
{month:10,date:"3 oct",name:"Estreno ANIMAL (Netflix)",cat:"serie",note:"Luis Zahera en la Espana rural. Drama de autor espaniol.",clients:["CaixaBank","Abanca","Gallina Blanca","Torres Brandy"]},
...
{month:10,date:"8 oct",name:"Estreno LA SUERTE (Disney+)",cat:"serie",note:"Comedia de Paco Plaza con taxista y torero. Produccion espanola.",clients:["CaixaBank","Abanca","Torres Brandy","Freixenet"]},
{month:10,date:"TBC oct",name:"The Strokes - Barcelona",cat:"concierto",note:"El quinteto de rock de New York regresa a Barcelona. Uno de los conciertos mas esperados del otonio.",clients:["Torres Brandy","Freixenet","AOC","CaixaBank"]},
...
{month:10,date:"11 oct",name:"Dia Internacional de la Nina 👧",cat:"daykeeting",note:"Igualdad y derechos. Marcas con valores.",clients:["CaixaBank","Abanca","Hero","Freshly Cosmetics","Staedtler"]},
...
{month:10,date:"15 oct",name:"VisionQuest (Disney+)",cat:"serie",note:"Nueva serie de ciencia ficcion de Disney+. Muy esperada por los fans de la plataforma.",clients:["AOC","CaixaBank","Abanca","Haribo","Nutella"]},
...
{month:10,date:"21 oct",name:"Terminal List T2 (Prime Video)",cat:"serie",note:"Regreso de Chris Pratt en el thriller militar mas visto de Amazon. Muy esperado.",clients:["AOC","CaixaBank","Abanca"]},
{month:10,date:"24 oct",name:"Dia Internacional contra el Cambio Climatico 🌡️",cat:"daykeeting",note:"Medioambiente y sostenibilidad.",clients:["Freshly Cosmetics","Jotun","CaixaBank","Abanca","Parlem","Granini"]},
...
{month:10,date:"TBC oct",name:"Anastaica - gira Espana (Donostia, Gijon, Pamplona)",cat:"concierto",note:"La diva del pop europeo con grandes exitos en Espana.",clients:["Freixenet","Torres Brandy","CaixaBank","Abanca"]},
{month:10,date:"TBC oct",name:"Band of Horses - Madrid y Barcelona",cat:"concierto",note:"El grupo de indie americano regresa a Espana. Muy esperado por fans del genero.",clients:["Torres Brandy","Freixenet","AOC","CaixaBank"]},
...
{month:11,date:"11 nov",name:"The Rings of Power T3 (Prime Video)",cat:"serie",note:"La epica serie del Senor de los Anillos de Amazon regresa. Una de las mas caras de la historia de la television.",clients:["AOC","CaixaBank","Abanca","Haribo","Nutella","Granini"]},
...
{month:11,date:"20 nov",name:"Los Juegos del Hambre: Amanecer en la Cosecha",cat:"pelicula",note:"Nueva precuela del universo Katniss. Francis Lawrence.",clients:["Haribo","Nutella","Hero","Granini","CaixaBank","Abanca"]},
{month:11,date:"20-22 nov",name:"GP MotoGP Valencia - Cheste (FINAL TEMPORADA)",cat:"deporte",note:"Ultima carrera del Mundial de MotoGP 2026. Gran emotividad.",clients:["Castrol","Frigicoll","AOC","CaixaBank","Abanca","Torres Brandy","Freixenet"]},
...
{month:11,date:"TBC nov",name:"28 Anios Despues: El Templo de los Huesos",cat:"pelicula",note:"Secuela de 28 anios despues (2025). Nia DaCosta. Terror zombi britanico.",clients:["AOC","Haribo","Freixenet","Torres Brandy"]},
...
{month:12,date:"3 dic",name:"Dia del Medico 👨‍⚕️",cat:"farma",note:"La profesion medica. Todo el portfolio farma.",clients:["Pilexil","Fito","MBS","Isogona","Dormidina","Rinocusi","Talquistina","Serelys"]},
...
{month:12,date:"6 dic",name:"Dia de la Constitucion Espanola",cat:"festivo",note:"Festivo nacional. Valores democraticos.",clients:["CaixaBank","Abanca","Torres Brandy","Freixenet"]},
...
{month:12,date:"11 dic",name:"Jumanji 3",cat:"pelicula",note:"Dwayne Johnson, Jack Black, Kevin Hart. Cine familiar navideno.",clients:["Haribo","Nutella","Hero","Granini","Freixenet","CaixaBank"]},
...
{month:12,date:"18 dic",name:"DOBLE BOMBAZO: Avengers Doomsday + Dune 3",cat:"pelicula",note:"Avengers con RDJ + Dune Parte 3 (Chalamet, Zendaya) el mismo dia. Fin de anio sin precedentes.",clients:["Haribo","Nutella","AOC","Granini","Hero","Freixenet","CaixaBank"]},
...
{month:12,date:"21 dic",name:"Solsticio de Invierno ❄️",cat:"daykeeting",note:"El dia mas corto del anio. Contenido poetico y estacional.",clients:["Freixenet","Freshly Cosmetics","Jotun","Torres Brandy","CaixaBank"]},
...
{month:12,date:"22 dic",name:"Paga Extra de Navidad",cat:"fiscal",note:"Nominas dobles. Pico de consumo navideno.",clients:["CaixaBank","Abanca","M2P","Pagofacil","Freixenet","Torres Brandy","Makro","Haribo","Nutella"]},
    ...
    <div style={{fontFamily:"'Rethink Sans',sans-serif",background:J.bg,minHeight:"100vh",color:J.text}}>
      ...
      <div style={{maxWidth:1280,margin:"0 auto",padding:"1.5rem 2rem"}}>
        ...
        <div style={{marginTop:"2.5rem",padding:"1.2rem 1.5rem",background:J.white,border:`1.5px solid ${J.border}`,borderRadius:12}}>
          ...
          <div style={{fontSize:"0.68rem",color:"#aaa",lineHeight:1.6}}>Fuentes: Metricool · Seriemaniac · FilmAffinity · Espinof · CNN Espanol · esmadrid.com · educaweb · FIFA 2026 · AEAT · SantandersMusic · Songkick · wakeandlisten.com<br/>Actualizado julio 2026 — Jirada Social Creative Agency</div>
        </div>
      </div>
    </div>
  );
